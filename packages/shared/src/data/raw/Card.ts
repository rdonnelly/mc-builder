...
const cards: ICardRaw[] = [].concat(
  ...
  require('marvelsdb-json-data/pack/bp_encounter.json'),
  require('marvelsdb-json-data/pack/bp.json'),
  ...
  require('marvelsdb-json-data/pack/falcon_encounter.json'),
  require('marvelsdb-json-data/pack/falcon.json'),
  ...
  require('marvelsdb-json-data/pack/iceman_encounter.json'),
  require('marvelsdb-json-data/pack/iceman.json'),
  require('marvelsdb-json-data/pack/ironheart_encounter.json'),
  require('marvelsdb-json-data/pack/ironheart.json'),
  require('marvelsdb-json-data/pack/jubilee_encounter.json'),
  require('marvelsdb-json-data/pack/jubilee.json'),
  require('marvelsdb-json-data/pack/magneto_encounter.json'),
  require('marvelsdb-json-data/pack/magneto.json'),
  ...
  require('marvelsdb-json-data/pack/ncrawler_encounter.json'),
  require('marvelsdb-json-data/pack/ncrawler.json'),
  ...
  require('marvelsdb-json-data/pack/silk_encounter.json'),
  require('marvelsdb-json-data/pack/silk.json'),
  ...
  require('marvelsdb-json-data/pack/winter_encounter.json'),
  require('marvelsdb-json-data/pack/winter.json'),
